...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Lato:100,300,300i,400' rel='stylesheet' type='text/css'>
...
<body>
   <header>
        ...
        <div class="row">
            ...
            <section class="section-cities" id="cities">
                ...
                <div class="row js--wp-3">
                    ...
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/dublin.jpg" alt="Dublin">
                        <h3>Dublin</h3>
                        <div class="city-feature">
                            <i class="ion-ios-person icon-small"></i>
                            1200+ happy eaters
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    <div>
                        <h3>Premium</h3>
                        <p class="plan-price">&euro;399 <span>/ month</span></p>
                        <p class="plan-price-meal">That's only &euro;13.30 per meal</p>
                    </div>
                    <div>
                        <ul>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    <div>
                        <h3>Pro</h3>
                        <p class="plan-price">&euro;149 <span>/ month</span></p>
                        <p class="plan-price-meal">That's only &euro;14.90 per meal</p>
                    </div>
                    <div>
                        <ul>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    <div>
                        <h3>Starter</h3>
                        <p class="plan-price">&euro;19 <span>/ meal</span></p>
    ...
    <script src="https://cdn.jsdelivr.net/selectize/0.12.4/js/selectize.min.js"></script>
